      ...
      <div class="bg-zinc-900 rounded-lg w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div class="flex items-center justify-between p-4 border-b border-zinc-800">
          <h2 class="font-bold text-lg">
            <i class="fa-solid fa-palette mr-2" />
            Theme & Colors
          </h2>
            ...
            <div class="mt-4">
              ...
              <div class="flex flex-wrap gap-2">
                {DEFAULT_PALETTES.map((preset) => (
                  ...
                  >
                    <div class="flex">
                      <div class="w-3 h-3 rounded-l" style={{ background: preset.palette.primary }} />
                      <div class="w-3 h-3" style={{ background: preset.palette.secondary }} />
                      <div class="w-3 h-3 rounded-r" style={{ background: preset.palette.accent }} />
                    </div>
                    {preset.name}
                  </button>
                ))}
          ...
          <div>
            ...
            <div class="grid grid-cols-4 gap-2 mb-3">
              {gradients.map((g) => (
                ...
                >
                  <div class="h-12 rounded" style={{ background: g.css }} />
              ...
              >
                <div class="h-12 rounded bg-zinc-800 flex items-center justify-center">
                  <i class="fa-solid fa-code text-zinc-500" />
                </div>
            ...
            {selectedGradient === 'custom' && (
              <div>
                ...
                />
                <div class="mt-2 h-16 rounded" style={{ background: customGradient }} />
              </div>
            )}
            ...
            <div class="mt-3">
              ...
              <div class="h-20 rounded" style={{ background: currentPreviewGradient }} />
            </div>
          </div>
        ...
        <div class="flex gap-3 p-4 border-t border-zinc-800">
          ...
          >
            <i class="fa-solid fa-check mr-1" /> Apply Theme
          </button>
        </div>
      </div>
    </div>
